...
Funciona bem para jogos com fator de ramificação muito grande e para quando é difícil definir uma vantajosa função de avaliação do estado do jogo. Pode operar sem qualquer tipo de conhecimento, apenas das regras e se ganha ou perde. Por outro lado gasta demasiado tempo e a memória é amplamente alargada com o crescimento da árvore e ramificações. Funcionamento do algoritmo:
